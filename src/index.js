...
export { toDoList, storage, storeToDoList, createProject, sidebar, domList, removeToDoList, dialogDetailList}

const todo1 = new toDoList('ini tugas');

const todo2 = new toDoList('ride a bike to mountain', 'Inbox', '03/01/2026', true);
